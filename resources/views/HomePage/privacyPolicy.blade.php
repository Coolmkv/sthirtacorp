...
@section('content')
    <div class="information-page-slider">
        <img src="assets/img/travel-with-landmarks.jpg" srcset="assets/img/travel-with-landmarks.jpg, assets/img/travel-with-landmarks-mobile.png 767w" alt="The Luxury Travels" class="img-fluid">
        ...
        <div class="default-content pt-5 pb-3">
            <div class="custom-container">
                ...
                <div class="midd-content">
                    ...
                    <p class="text-justify"><b>THE LUXURY TRAVEL</b> may change this Policy periodically and we urge you to check this page for the latest version of the Policy in order to keep yourself updated.</p>
                    ...
                    <p class="text-justify"><b><i>Withdrawal of your Consent</i></b> - You can choose not to provide your data, at any time while availing our goods or services or otherwise withdraw your consent provided to us earlier, in writing to our email ID: <a href="mailto:theluxurytravel.in@gmail.com">theluxurytravel.in@gmail.com</a> In the event you choose to not provide or later withdraw your consent, we may not be able to provide you our services or goods.Please note that these rights are subject to our compliance with applicable laws.</p>
                ...
                <div class="midd-content">
                    <p class="text-justify"><b>THE LUXURY TRAVEL</b> believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
                    <ul>
                        <li><p class="text-justify">Cancellations will be considered only if the request is made immediately after placing the order. However, the cancellation request may not be entertained if the orders have been communicated to the vendors/merchants and they have initiated the process of shipping them.</p></li>
                        <li><p class="text-justify"><b>THE LUXURY TRAVEL</b> does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</p></li>
                        <li><p class="text-justify">In case of receipt of damaged or defective items please report the same to our Customer Service team. The request will, however, be entertained once the merchant has checked and determined the same at his own end. This should be reported within 7 Days days of receipt of the products. In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within 7 Days days of receiving the product. The Customer Service Team after looking into your complaint will take an appropriate decision.</p></li>
                        <li><p class="text-justify">In case of complaints regarding products that come with a warranty from manufacturers, please refer the issue to them. In case of any Refunds approved by the <b>THE LUXURY TRAVEL</b>, it’ll take 9-15 Days days for the refund to be processed to the end customer.</p></li>
                    </ul> 
                </div>
                <div class="site-title pt-3 pb-2">
                ...
                <div class="midd-content">
                    ...
                    <p class="text-justify"><b>THE LUXURY TRAVEL</b> is not liable for any delay in delivery by the courier company / postal authorities and only guarantees to hand over the consignment to the courier company or postal authorities within 3-5 Days days from the date of the order and payment or as per the delivery date agreed at the time of order confirmation. Delivery of all orders will be to the address provided by the buyer. Delivery of our services will be confirmed on your mail ID as specified during registration. For any issues in utilizing our services you may contact our helpdesk on <a href="tel:+919540721363">+91 954 072 1363</a> or <a href="mailto:theluxurytravel.in@gmail.com">theluxurytravel.in@gmail.com</a>.</p>
                </div>
            </div>
        </div>
    </div>
